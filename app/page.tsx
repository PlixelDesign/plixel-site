  ...
  return (
    <>
      ...
      <main className="bg-black text-white selection:bg-yellow-neon selection:text-navy-deep antialiased overflow-x-hidden">
        {/* 01. Hero Section (Headline B2B + 3D Interactive Animated Cybernetic Core) */}
        <Hero />
        ...
        {/* 04. Rodapé de Conversão B2B Awwwards (Frase toda em Fonte Parisienne) */}
        <section className="relative section-mid section-y overflow-hidden border-t border-white/10">
          ...
          <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center relative z-10 space-y-8">
            ...
            {/* H2 Chamada B2B inteiramente em fonte Parisienne (Diretriz do Usuário) */}
            <h2 className="title-impact text-[clamp(34px,5.5vw,76px)] text-yellow-neon font-normal normal-case leading-relaxed font-parisienne tracking-normal text-center select-none drop-shadow-[0_4px_24px_rgba(255,215,0,0.15)] max-w-3xl mx-auto">
