  ...
  return (
    <div className="min-h-screen bg-black text-white font-plus-jakarta selection:bg-[#c48b56] selection:text-black relative overflow-x-hidden antialiased">
      ...
      <section id="hero" className="relative w-full min-h-[60vh] sm:min-h-[75vh] md:h-screen flex flex-col justify-between overflow-hidden bg-black">
        ...
        {/* Título Monumental & Headline de Negócio */}
        <div className="relative z-30 pb-8 md:pb-16 px-6 md:px-12 max-w-[95vw] space-y-4">
          <h1 className="text-4xl sm:text-7xl md:text-8xl lg:text-[9.5rem] font-normal tracking-tight text-[#f5ebe0] leading-none select-none drop-shadow-2xl font-dm-serif">
            Jennifer Lemmos <span className="text-[#c48b56] italic font-light">— Posicionamento de Luxo</span>
          </h1>
          <p className="text-base sm:text-xl md:text-2xl text-[#f5ebe0]/90 max-w-4xl font-plus-jakarta font-light drop-shadow leading-relaxed">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-l border-white/10">
        ...
        <section id="diagnostico" className="scroll-mt-32 py-20 md:py-36 relative">
          <div className="border-l-2 border-[#c48b56] pl-6 md:pl-12 max-w-5xl space-y-8">
            ...
            <h2 className="text-4xl sm:text-6xl font-normal text-[#f5ebe0] tracking-tight font-dm-serif">
              O Gargalo de Escala e Reprodução
            </h2>

            <p className="text-lg sm:text-2xl text-slate-300 font-light leading-relaxed font-plus-jakarta">
            ...
            <div className="pt-6 flex flex-wrap items-center gap-8 text-xs font-plus-jakarta text-[#f5ebe0]/70">
              <div>
                <span className="block text-slate-500 uppercase font-semibold">Segmento</span>
                <span className="text-[#f5ebe0] font-bold">Fotografia de Alta Cultura &amp; Luxo</span>
              </div>
              <div className="h-6 w-px bg-white/10 hidden sm:block" />
              <div>
                <span className="block text-slate-500 uppercase font-semibold">Engenharia</span>
        ...
        <section id="engenharia-vetorial" className="scroll-mt-32 py-20 md:py-36 relative space-y-24 border-t border-white/10">
          ...
          <div className="space-y-6 w-full">
            <div className="space-y-2">
              ...
              <h3 className="text-3xl sm:text-5xl font-normal text-[#f5ebe0] font-dm-serif">
            ...
            <p className="text-sm md:text-base text-slate-300 font-light leading-relaxed max-w-4xl font-plus-jakarta border-l border-white/20 pl-4 py-1">
