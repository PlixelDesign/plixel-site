...
export default function HeroGraphic() {
  ...
  return (
    <div
      aria-hidden
      className="hero-cube-scene pointer-events-none absolute z-0 right-0 top-1/2 -translate-y-1/2 scale-[0.45] opacity-[0.15] sm:right-0 sm:scale-75 sm:opacity-30 lg:right-8 xl:right-20 lg:scale-90 lg:opacity-50 overflow-hidden"
    >
